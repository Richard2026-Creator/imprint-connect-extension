...
- It does not collect or store your personal information.
- It does not transmit any data to the developer or to any third-party server.
- It does not track your browsing activity.
- It does not use analytics, advertising, or cookies.
- It does not access any pages other than Pinterest pages you choose to scan.
...
The extension stores nothing. The list of pins exists only in memory while the popup is open and is discarded when you close it. Downloaded images are saved only where you choose to save the ZIP file.

## Contact

For questions about this policy, contact the developer through the Chrome Web Store listing's support channel.
